...
window.KhronosView = function() {
    ...
    this.startPreview = function() {
		...
		viewer = gltf_rv('canvas', 'assets/models/2.0/model-index.json', false, undefined, "vscode-resource:c:/Development/GitHubOthers/gltf-vscode/engines/Khronos/", gltfFileName, gltfRootPath);
